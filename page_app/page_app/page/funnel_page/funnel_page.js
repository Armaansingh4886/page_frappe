// frappe.pages['funnel-page'].on_page_load = function(wrapper) {
...
frappe.pages["funnel-page"].on_page_load = function (wrapper) {
	...
	wrapper.funnel_page = new erpnext.FunnelPage(wrapper);

	frappe.breadcrumbs.add("Selling");
	
};

erpnext.FunnelPage = class FunnelPage {
	constructor(wrapper) {
		var me = this;
	...
	get_data(btn) {
		...
		const method_map = {
			sales_funnel: "page_app.page_app.page.funnel_page.funnel_page.get_funnel_data",
			opp_by_lead_source: "page_app.page_app.page.funnel_page.funnel_page.get_opp_by_lead_source",
			sales_pipeline: "page_app.page_app.page.funnel_page.funnel_page.get_pipeline_data",
		};
		frappe.call({
